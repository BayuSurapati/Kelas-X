    ...
    <body>    
            <table class="table table-striped">
                ...
                <tbody style="text-align:center;">
                    <?php 
                    $qry_detail=mysqli_query($conn,"select * from detail_transaksi join paket on detail_transaksi.id_paket = paket.id_paket where detail_transaksi.id_transaksi = '".$dt_transaksi['id_transaksi']."'");
                    $total = 0;
