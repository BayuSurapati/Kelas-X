        ...
        <div class="container">
            ...
            <div style="width:600px;float:right;">
                ...
                <form action="checkout.php" class="well form-horizontal" method="post">
                    ...
                    Status : 
                    <?php 
                        $arr_status_bayar=array('lunas'=>'Dibayar','belum_lunas'=>'Belum Dibayar');
                    ?>
                    <select name="status_bayar" class="form-control">
                        <option></option>
                        <?php foreach ($arr_status_bayar as $key_status_bayar => $val_status_bayar):?>
                        <option value="<?=$key_status_bayar?>"><?=$val_status_bayar?></option>
                        <?php endforeach ?>
                    </select>
                    <br>
