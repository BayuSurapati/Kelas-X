        ...
        <table class="table table-hover">
            ...
            <tbody style="text-align:center;">
                <?php 
                    ...
                    ?>
                <tr>
                    <td><?=$no?></td><td><?=$dt_histori['nama']?></td><td><?=$dt_histori['tgl_transaksi']?></td><td><?=$dt_histori['batas_waktu']?></td><td><?=$dt_histori['tgl_bayar']?></td><td><?=$dt_histori['status_order']?></td><td><?=$dt_histori['status_bayar']?></td>
                    <?php if($dt_histori['status_bayar']=='belum_lunas'){ ?>
                            <td><?=$button_lunas?></td>
                    <?php        
                        }
                    ?>
                    ...
                    ?>
                    <?php if($dt_histori['status_order']=='diproses'){ ?>
