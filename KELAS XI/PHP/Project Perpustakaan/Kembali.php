...
if($_GET['id']){
    ...
    $cek_terlambat=mysqli_query($conn, "select * from peminjaman_buku where id_peminjamanBuku = '".$id_peminjaman_buku."' ");
    ...
    mysqli_query($conn, "insert into pengembalian_buku (id_peminjamanBuku, tanggal_pengembalian, denda) value('".$id_peminjaman_buku."','".date('Y-m-d')."','".$denda."')");
