...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        if(empty($password)){
            ...
            if($update){
                echo "<script>alert('Sukses update siswa');location.href='TampilSiswa.php';</script>";
            } else {
                echo "<script>alert('Gagal update siswa');location.href='UbahSiswa.php?id_siswa=".$id_siswa."';</script>";
            }
        } else {
